<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDeInformacionDeReprocesos.aspx.vb"
    Inherits="BPColSysOP.Reporte_DeInformacionDeReprocesos" %>
...
<head runat="server">
    <title>Reporte De Informacion De Reprocesos</title>
        ...
        function ProcesarCarga(s, e) {
            ...
            if (s.cpResultadoProceso != null) {
                if (s.cpResultadoProceso == 0) {
                    ...
                    btnDescargaArchivo.SetClientVisible(false);
                    $('#divpnlErrores').css('visibility', 'visible');
                } else {
                    btnDescargaArchivo.SetClientVisible(true);
                    LoadingPanel.Hide();
                }
                LoadingPanel.Hide();
            }
    ...
    <div>
        ...
        <div style="float: left; margin-right: 20px; margin-bottom: 20px; margin-top: 15px;
            ...
            <dx:ASPxCallbackPanel ID="cpRegistro" runat="server" ClientInstanceName="cpRegistro">
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <dx:ASPxRoundPanel ID="rpUltimoCliente" runat="server" HeaderText="Consulta De Informacion De Reprocesos"
                            Width="50%">
                            <PanelCollection>
                                <dx:PanelContent>
                                    <table cellpadding="1" width="90%">
                                        <tr>
                                            <td>
                                                ...
                                                <div style="float: left; margin-top: 5px; margin-bottom: 5px;">
                                                    <dx:ASPxButton ID="btnDescargaArchivo" runat="server" AutoPostBack="false" Text="Descargar Archivo Generado" 
                                                         ClientInstanceName="btnDescargaArchivo" ClientVisible="False" >
