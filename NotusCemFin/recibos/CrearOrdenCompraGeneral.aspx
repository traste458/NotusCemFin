<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CrearOrdenCompraGeneral.aspx.vb" 
    Inherits="BPColSysOP.CrearOrdenCompraGeneral" %>
...
<body class="cuerpo2" id="contenedor" style="background: none; margin: 0;">
    ...
    <asp:ScriptManager ID="smAjaxManager" runat="server" EnableScriptGlobalization = "true">
            ...
            <table class="tablaGris" style="width: 100%">
                ...
                <tr>
                    <td style="width: 140px;" class="field">
                        Numero de Orden:
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <asp:UpdatePanel ID="upGeneral" runat="server">
                        ...
                        <asp:Panel ID="pnlListarDetalleOrdenCompra" runat="server" ScrollBars="Vertical">
                        ...
                        <asp:GridView ID="gvRegion" runat="server" AutoGenerateColumns="False">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Cantidad">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtCantidadRegion" MaxLength="8" runat="server" onblur="CalcularTotalDistribucion();"></asp:TextBox>
                                        <div style="display: block">
                ...
                <tr id="trAccesorios" runat="server">
                    ...
                    <td>
                        ...
                        <table class="tablaGris" style="width:700px;">
                            <tr>
                                <th colspan="2">Producto Adicionales</th>
                            </tr>
                            <tr>
