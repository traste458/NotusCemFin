<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CierredeCicloSerialesdevoluciones.aspx.vb"
    Inherits="BPColSysOP.CierredeCicloSerialesdevoluciones" %>
...
<head runat="server">
    <title>Cierre de ciclo devoluciones</title>
    ...
    <script type="text/javascript">
        ...
        function Limpiar() {
            deFechaCierre.SetDate(new Date(1900, 0, 1));
    ...
    <div>
        ...
        <div style="float: left; margin-right: 20px; margin-bottom: 20px; margin-top: 15px;
            ...
            <dx:ASPxCallbackPanel ID="cpRegistro" runat="server" ClientInstanceName="cpRegistro"
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <dx:ASPxRoundPanel ID="rpCierreCiclo" runat="server" HeaderText="Cierre de ciclo devoluciones"
                            Width="60%">
                            <PanelCollection>
                                <dx:PanelContent>
                                    <dx:ASPxFormLayout ID="Cplayout" runat="server" RequiredMarkDisplayMode="Auto" AlignItemCaptionsInAllGroups="true">
                                        <Items>
                                            <dx:LayoutGroup Caption="&nbsp;" ColCount="3" GroupBoxDecoration="None" SettingsItemCaptions-HorizontalAlign="Right">
                                                <Items>
                                                    <dx:LayoutItem Caption="Fecha Cierre" HorizontalAlign="Left">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxDateEdit ID="deFechaCierre" ClientInstanceName="deFechaCierre" runat="server">
                                                                </dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
