<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetalleOrdenRecepcionMerchandising.aspx.vb"
    Inherits="BPColSysOP.DetalleOrdenRecepcionMerchandising" %>
                ...
                <table class="tablaGris" width="800px">
                    ...
                    <tr>
                        <td colspan="4">
                            <br />
                            <br />
                            <asp:LinkButton ID="lbCerrarOrden" runat="server" CssClass="search" OnClientClick="return CompararCantidad();"><img src="../images/save_all.png" alt=""/>&nbsp;Cerrar Orden</asp:LinkButton>
                        </td>
                    </tr>
                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Columns="40" Rows="3" 
                                                TextMode="MultiLine" ValidationGroup="crearPallet" MaxLength="399"></asp:TextBox>
                                            <div>
                                                <asp:RegularExpressionValidator ID="revObservacion" runat="server" ValidationExpression="^([a-zA-Z_0-9áéíóúñÁÉÍÓÚÑ])([a-zA-Z_0-9,\-\s\.áéíóúñÁÉÍÓÚÑ])*([a-zA-Z_0-9áéíóúñÁÉÍÓÚÑ])*$"
                                                    Display="Dynamic" ValidationGroup="crearPallet" ControlToValidate="txtObservacion" ErrorMessage="La observación contiene caracteres no validos, por favor verifique."></asp:RegularExpressionValidator>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <asp:TextBox ID="txtFiltroMaterial" runat="server" Width="80px" MaxLength="15" 
                                                            onkeyup="RefrescaUpdatePaneOrden('txtFiltroMaterial','hfFlagFiltradoOrden');"></asp:TextBox>
                                                        -
            ...
            <table class="tablaGris">
                                <tr id="trProductoAdicional" runat="server">                                        
                                        <td colspan="2">
                                            ...
                                            <div>
                                                <asp:LinkButton ID="lnkAgregarProductoAdicional" runat="server" ValidationGroup="crearAdicional" CssClass="search"><img src="../images/Folder-add-32.png" alt="" />&#160;Adicionar</asp:LinkButton>                                                
             ...
             <table class="tablaGris" id="tblCrearPalletAdicional" runat="server">
                ...
                <tr>
                    <td colspan="2">                                            
                        <asp:LinkButton ID="lnkCrearPalletProAdicional" runat="server" CssClass="search" ValidationGroup="crearPalletAdicional"><img 
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="gvPallets" runat="server" AutoGenerateColumns="False" CssClass="tablaGris"
                                            ...
                                            EmptyDataText="&lt;blockquote&gt;No se han adicionado Pallets a la orden&lt;/blockquote&gt;">
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" 
                                                    HeaderText="Productos Agregados">
                                                    <ItemTemplate>
