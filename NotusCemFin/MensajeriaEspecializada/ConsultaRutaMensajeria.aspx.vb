...
Partial Public Class ConsultaRutaMensajeria
...
#Region "Métodos"
        ...
        Try
            ...
            Select Case idTipoRuta
                Case Enumerados.TipoRutaServicioMensajeria.EntregaCliente
                    ...
                    If lisTiposServicio(0) = Enumerados.TipoServicio.Venta Then
                        If serializada Then
                            ...
                            cargareporte("Reportes/VisorHojaRutaSerializado.aspx?id=" & idRuta.ToString())
                        Else
                            cargareporte("Reportes/VisorHojadeRutaSerTipoVenta.aspx?id=" & idRuta.ToString())
                    ...
                    Else
                        ...
                        Else
                            'rpt = New ReporteCrystal("HojaRuta", Server.MapPath("../MensajeriaEspecializada/Reportes"))
                            'Server.Transfer("Reportes/VisorHojaRuta.aspx?id=" & idRuta.ToString(), True)
                            'Response.Redirect("Reportes/VisorHojaRuta.aspx?id=" & idRuta.ToString())
                            cargareporte("Reportes/VisorHojaRuta.aspx?id=" & idRuta.ToString())
                        End If
                    End If
                ...
                Case Enumerados.TipoRutaServicioMensajeria.RecoleccionCliente
                    ...
                    cargareporte("Reportes/VisorReporteHojaRutaRecoleccion.aspx?id=" & idRuta.ToString())

                Case Enumerados.TipoRutaServicioMensajeria.EntregaProveedorServicioTecnico
                    cargareporte("Reportes/VisorOrdenDespachoServicioTecnico.aspx?id=" & idRuta.ToString())
                ...
                Case Enumerados.TipoRutaServicioMensajeria.RecoleccionProveedorServicioTecnico
                    ...
                    Dim RutaRelativa As String = "../archivos_planos/" & ruta & ""
    ...
    Private Sub cargareporte(ByVal url As String)
        ...
        sb.Append(url)
        sb.Append("','Impresión', 'toolbar=no, location=no, directories=no, status=1, menubar=no, scrollbars=0, resizable=1, copyhistory=no, width=1000, height=600, top=10, left=10');")
        sb.Append("</script>")
        ClientScript.RegisterStartupScript(Me.GetType(), _
                  "script", sb.ToString())
        cpGeneral.RenderScriptBlock("Impresión", sb.ToString(), False)
    End Sub
