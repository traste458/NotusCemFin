...
Public Class ReporteGeneralSiembra
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            epNotificador.setTitle("Reporte General Servicios Siembra")
        End If
    End Sub
...
#Region "Métodos Privados"
    Private Sub ObtenerDatosReporte(sender As Object)
        Try
            ...
            Dim reporte As New ReporteGeneralServiciosSiembra
            ...
            With reporte
                ...
                .NombreArchivo = Server.MapPath("~/archivos_planos/" & "ReporteGeneralServiciosSiembra_" & Session("usxp001") & "_" & fecha & ".xlsx")
                .NombrePlantilla = Server.MapPath("~/MensajeriaEspecializada/Plantillas/PlantillaReporteGeneralServiciosSiembra.xlsx")
                .ObtenerReporte()
            End With
