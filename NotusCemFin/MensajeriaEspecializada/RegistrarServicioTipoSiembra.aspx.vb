...
Public Class RegistrarServicioTipoSiembraNew1
            ...
            Select Case arrParametros(0)
                Case "registrar"
                    ...
                    With objServicioSiembra
                        ...
                        ._Direccion = memoDireccion1.value
                        ._Observacion = memoObservaciones.Text
                        ._ObservacionDireccion = memoObservacionDireccion.Text
...
#Region "Métodos Privados"
    ...
    Private Sub cargarCiudades()
        ...
        With cmbCiudadEntrega
            ...
            If dtCiudad.Rows.Count = 1 Then
                .SelectedIndex = 0
            Else
                .SelectedIndex = .Items.IndexOf(.Items.FindByValue(CStr(Session("usxp007"))))

                '.SelectedItem = .Items.FindByValue(CStr(Session("usxp007")))
                '.Value = CStr(Session("usxp007"))
            End If
        End With
        'cmbCiudadEntrega.SelectedItem = cmbCiudadEntrega.Items.FindByValue(CStr(Session("usxp007")))
    End Sub
    ...
    Private Sub LimpiarFormulario()
        Try
            ...
            memoDireccion1.value = Nothing
            memoDireccion1.Limpiar()
    ...
    Private Sub Cargarregistro()
        ...
        With objServicioSiembra
            If ._estructuraTablaErrores IsNot Nothing Then
                ...
                End If
                If (._idciudad <> 0) Then
                    cmbCiudadEntrega.SelectedIndex = cmbCiudadEntrega.Items.IndexOf(cmbCiudadEntrega.Items.FindByValue(CStr(._idciudad)))
                ...
                memoDireccion1.value = ._Direccion
