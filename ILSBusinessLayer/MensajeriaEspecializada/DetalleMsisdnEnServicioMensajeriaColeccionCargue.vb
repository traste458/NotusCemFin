...
Public Class DetalleMsisdnEnServicioMensajeriaColeccionCargue
...
#Region "Atributos (Filtros de Búsqueda)"
    ...
    Private _hayCambioServicio As Enumerados.EstadoBinario
...
#Region "Métodos Privados"
    ...
    Private Function CrearEstructuraDeTabla() As DataTable
        ...
        Dim miDetalleMsisdnEnServicioMensajeriaCargue As Type = GetType(DetalleMsisdnEnServicioMensajeriaCargue)
        Dim pInfo As PropertyInfo

        For Each pInfo In miDetalleMsisdnEnServicioMensajeriaCargue.GetProperties
...
#Region "Métodos Públicos"
    ...
    Public Function GenerarDataTable() As DataTable
        ...
        Dim miDetalle As DetalleMsisdnEnServicioMensajeriaCargue

        For index As Integer = 0 To Me.InnerList.Count - 1
            drAux = dtAux.NewRow
            miDetalle = CType(Me.InnerList(index), DetalleMsisdnEnServicioMensajeriaCargue)
            If miDetalle IsNot Nothing Then
                For Each pInfo As PropertyInfo In GetType(DetalleMsisdnEnServicioMensajeriaCargue).GetProperties
                    If pInfo.PropertyType.Namespace = "System" Then
        ...
        Try
            ...
            With dbManager
                ...
                If .Reader IsNot Nothing Then
                    Dim elDetalle As DetalleMsisdnEnServicioMensajeriaCargue
                    While .Reader.Read
                        elDetalle = New DetalleMsisdnEnServicioMensajeriaCargue
