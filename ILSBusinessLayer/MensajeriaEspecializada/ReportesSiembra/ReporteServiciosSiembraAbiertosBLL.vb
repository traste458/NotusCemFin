...
Namespace MensajeriaEspecializada
    ...
    Public Class ReporteServiciosSiembraAbiertosBLL
            ...
            Using dbManager As New LMDataAccess
                Try
                    With dbManager
                        ...
                        If _numeroDias > 0 Then .SqlParametros.Add("@numeroDias", SqlDbType.Int).Value = _numeroDias

                        dtReporte = .ejecutarDataTable("ReporteServiciosSiembraAbiertos", CommandType.StoredProcedure)
                    End With
