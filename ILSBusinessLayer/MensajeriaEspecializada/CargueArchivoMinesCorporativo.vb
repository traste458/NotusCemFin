...
Public Class CargueArchivoMinesCorporativo
...
#Region "Métodos Privados"
        ...
        Try
            ...
            For Each registro As DataRow In dtDatos.Rows
                ...
                With registroFinal
                    ...
                    .Item("materialEquipo") = registro("materialEquipo").ToString.Trim
                    .Item("requiereSim") = registro("requiereSim").ToString.Trim
    ...
    Private Sub AdicionarRegistro(ByVal msisdn As String, ByVal region As String, ByVal precioUnitarioSinDescuento As Long, ByVal precioUnitario As Long _
                                  , ByVal precioEspecial As String, ByVal materialEquipo As String, ByVal requiereSim As String, ByVal codigoCuenta As String _
                                  , ByVal nombrePlan As String, ByVal tipoPlanVozDatos As String, ByVal valorCargoBasicoPlanSinImpuesto As String _
        ...
        Try
            With EstructuraTablaBase
                ...
                With drRegistro
                    ...
                    .Item("materialEquipo") = materialEquipo
                    .Item("requiereSim") = requiereSim
                        ...
                        If numCeldasActivas = Me.EstructuraTabla.Columns.Count AndAlso hayDatos Then
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    If (.Item(index).Cells(2).Value) > (.Item(index).Cells(3).Value) Then _
                            ...
                            If String.IsNullOrEmpty(.Item(index).Cells(5).Value) Then
                                AdicionarError(index, "Dato inválido", "El material no puede estar vacío.")
                            Else
                                dato = .Item(index).Cells(5).Value
                                If dato.Length > 20 Then _
                                    AdicionarError(index, "Dato inválido", "La longuitud del material no es válida.")
                            End If

                            If String.IsNullOrEmpty(.Item(index).Cells(6).Value) Then
                                AdicionarError(index, "Dato inválido", "El campo de requiere SIM, no puede estar vacío.")
                            Else
                                dato = .Item(index).Cells(6).Value
                                If dato.Length > 2 Then _
                                    AdicionarError(index, "Dato inválido", "La longuitud campo 'Requiere SIM' no es válido.")
                            End If
                            ...
                            Else
                                ...
                                If Not oExpReg1.IsMatch(.Item(index).Cells(7).Value) Then _
                            ...
                            If String.IsNullOrEmpty(.Item(index).Cells(13).Value) And (.Item(index).Cells(12).Value).ToString.ToLower.Trim = "si" Then
                            ...
                            Else
                                ...
                                If (.Item(index).Cells(12).Value).ToString.ToLower.Trim = "si" Then
                                    conClausula = True
                                End If
                            ...
                            If String.IsNullOrEmpty(.Item(index).Cells(16).Value) And (.Item(index).Cells(15).Value).ToString.ToLower.Trim = "si" Then
                            ...
                            Else
                                ...
                                If (.Item(index).Cells(15).Value).ToString.ToLower.Trim = "si" Then
                                    conCuotas = True
                                End If
                            ...
                            Else
                                dato = .Item(index).Cells(20).Value
                                If Not IsNumeric(dato) Then
                            ...
                            If String.IsNullOrEmpty(.Item(index).Cells(21).Value) Then
                            ...
                            If EstructuraTablaErrores.Rows.Count = 0 Then
                                AdicionarRegistro(.Item(index).Cells(0).Value, .Item(index).Cells(1).Value, .Item(index).Cells(2).Value, .Item(index).Cells(3).Value _
                                                  ...
                                                  , .Item(index).Cells(20).Value, .Item(index).Cells(21).Value)
                            End If
            ...
            Using dbManager As New LMDataAccess
                With dbManager
                    ...
                    With .BulkCopy
                        ...
                        .ColumnMappings.Add("materialEquipo", "materialEquipo")
                        .ColumnMappings.Add("requiereSim", "requiereSim")
