...
Namespace MensajeriaEspecializada
    ...
    Public Class ReporteCargueInventarioServicioFinancieros
            ...
            Using dbManager As New LMDataAccess
                Try
                    With dbManager
                        ...
                        _resultado = .GenerarArchivoExcel("ReporteCargueInventarioServicioFinanciero", NombreArchivo, CommandType.StoredProcedure, NombrePlantilla, "Reporte Cargue Inventario Servicio Financiero Tarjetas", 4)
                    End With
