...
Namespace Fulfillment
    Public Class ImpresionImeiConSerialDeProductoPromocional
            ...
            If Not EsNuloOVacio(Me._imei) AndAlso Not _cargado Then
                ...
                Try
                    With dbManager
                        ...
                        .ejecutarReader("ConsultarInfoImpresionSerialProductoPromocional", CommandType.StoredProcedure)
                        If .Reader IsNot Nothing AndAlso .Reader.Read Then
                            ...
                            _serialProductoPromocional = .Reader("serialProductoPromocional").ToString
        ...
        Public Sub Imprimir()
            ...
            Try
                ...
                With objPrint
                    ...
                    .Write("A20,175,0,3,1,1,N," & comilla & "S/M PROMO" & comilla)
                    .Write("B145,180,0,1,2,8,40,B," & comilla & Me._serialProductoPromocional.Trim.ToUpper & comilla)
