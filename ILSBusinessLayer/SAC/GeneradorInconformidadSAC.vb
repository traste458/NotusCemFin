...
Namespace SAC
    ...
    Public Class GeneradorInconformidadSAC

#Region "Atributos"

        Private _idGenerador As Short
...
#Region "Propiedades"
        ...
        Public ReadOnly Property IdGenerador() As Short
            Get
                Return _idGenerador
            End Get
        End Property
        ...
        Private Sub CargarDatos(ByVal identificador As Short)
            ...
            Try
                ...
                With dbManager
                    ...
                    .SqlParametros.Add("@idGenerador", SqlDbType.SmallInt).Value = identificador
                    .ejecutarReader("ConsultarGeneradorInconformidadSAC", CommandType.StoredProcedure)
                    If .Reader IsNot Nothing Then
                        If .Reader.Read Then
                            Short.TryParse(.Reader("idGeneradorInconformidad").ToString, _idGenerador)
