...
Namespace InventarioFisico
    ...
    Public Class ReporteDeSerialesSobrantesEnInventarioFisico
...
#Region "Propiedades"
        ...
        Public Property Justificado As String
...
#Region "Métodos Públicos"
        ...
        Public Sub CargarDatos()
            ...
            Try
                ...
                With dbManager
                    ...
                    _datosReporte = .EjecutarDataTable("ReporteDeSerialesSobrantesDeInventarioFisico", CommandType.StoredProcedure)
                    _cargado = True
                End With
            Finally
        ...
        Public Function GenerarArchivo(Optional ByVal ext As ExtensionArchivo = ExtensionArchivo.XLSX) As ResultadoProceso
            ...
            Dim rutaPlantilla As String = contexto.Server.MapPath("~/Reports/PlantillasYEjemplos/PlantillaReporteSobrantesInventarioFisico.xlsx")
            If File.Exists(rutaPlantilla) Then
                Dim oWs As ExcelWorksheet

                oExcel.LoadXlsx(rutaPlantilla, XlsxOptions.PreserveMakeCopy)
                oWs = oExcel.Worksheets("SobrantesInventarioFisico")
                ...
                Dim urlArchivo As String = "~/archivos_planos/ReporteSobrantesInventarioFisico_" & _
            ...
            Else
                resultado.EstablecerMensajeYValor(1, "No se encontró la plantilla del reporte de sobrantes en inventario físico. Por favor contracte a IT")
            End If
            Return resultado
        End Function
