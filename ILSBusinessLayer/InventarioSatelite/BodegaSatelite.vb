...
#Region "Metodos"
    ...
    Public Shared Function DespacharPedidoBodegaSatelite(idPedido As Integer, idUsuario As Integer) As ResultadoProceso
        Dim dbManager As New LMDataAccessLayer.LMDataAccess
        Dim resultado As New ResultadoProceso
        With dbManager
            Try
    ...
    End Function
    Public Shared Function ObtenerOtbBodegaSatelite(filtro As FiltrosOTB) As DataTable
        Dim resultado As New ResultadoProceso
        Dim db As New LMDataAccessLayer.LMDataAccess

        db.SqlParametros.Add("@idOtb", SqlDbType.Int).Value = filtro.IdOTB
        db.SqlParametros.Add("@idBodega", SqlDbType.Int).Value = filtro.IdBodega

        Return db.EjecutarDataTable("ObtenerOtbBodegaSatelite", CommandType.StoredProcedure)
    End Function
        ...
        With dbManager
            Try
                With .SqlParametros
                    ...
                    .Add("@idPedidoSerial", SqlDbType.BigInt).Direction = ParameterDirection.Output
                ...
                tienePedidoSap = .SqlParametros("@tienePedidoSap").Value.ToString
